...
const generateUniqueId = (prefix: string): string => `${prefix}-${Math.random().toString(36).substr(2, 9)}`
      ...
      >
        ...
        <defs>
          <linearGradient id="sharedGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="rgba(84, 63, 115, 0.6)" />
            <stop offset="50%" stopColor="rgba(198, 169, 243, 0.8)" />
            <stop offset="100%" stopColor="rgba(94, 76, 121, 0.6)" />
          </linearGradient>
        </defs>
